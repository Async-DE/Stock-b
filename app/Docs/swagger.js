  ...
  components: {
    schemas: {
      ...
      CreateProductoConVariante: {
        ...
        // note: alto/ancho/largo son opcionales, se calculará "medidas" si se proveen
        required: [
          "subcategoriaId",
          "ubi_alma_id",
          "nombre",
      ...
      CreateVariante: {
        ...
        // dimensiones opcionales; "medidas" se calcula en el servidor cuando estén presentes
        required: [
          "productoId",
          "ubi_alma_id",
          "nombre",
